...
knitr::opts_chunk$set(fig.align='center', dev='png', prompt=TRUE,
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.45\textwidth}
      \includegraphics[scale=0.35]{figures/Sim1Default.pdf}

    \end{subfigure}
    \begin{subfigure}[b]{0.45\textwidth}
      \includegraphics[scale=0.35]{figures/Sim1Labels.pdf}
    \end{subfigure}
    \end{center}
      \caption{An Example of a Dynamic Simulation of Three Scenarios}
      \label{defaultPlot}
\end{figure}
...
\begin{figure}
  \begin{center}
    \includegraphics[page=2,scale=0.55]{figures/Sim3Shockplot.pdf}
  \end{center}
