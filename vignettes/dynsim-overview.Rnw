...
\begin{figure}
    \begin{center}
    \begin{subfigure}
<<SimDefault-eval, tidy=FALSE, echo=FALSE, fig.height=4, fig.width=6>>=
dynsimGG(Sim1)
@

    \end{subfigure}
    \begin{subfigure}
<<Sim1Labels-eval,tidy=FALSE, echo=FALSE, fig.height=4, fig.width=6>>=
Labels <- c("95th Percentile", "Mean", "5th Percentile")
...
@
    \end{subfigure}
    \end{center}
        \caption{Plots of a Dynamic Simulation with Three Scenarios}
        \label{defaultPlot}
\end{figure}
